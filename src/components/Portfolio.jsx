...
import app2 from "../assets/img/portfolio/2.png";
...
const Portfolio = () => {
  const portfolios = [
    ...
    },
    {
      id: 2,
      title: "Task List",
      tech: "Flask/MySQL/Werkzeug",
      src: app2,
      href: "https://web-production-572f.up.railway.app/auth/register",
      code: "https://github.com/aaronosorio2000/todolist",
    },
    {
      id: 3,
      title: "Goals app",
  ...
  return (
    ...
    >
      <div className=" max-w-screen-xl p-4 mx-auto flex flex-col justify-center h-full">
        <div className=" py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 px-12 sm:px-0">
          {portfolios.map(({ id, src, href, code, title, tech }) => (
            <div key={id} className="">
              <button className=" flex justify-center items-center flex-col rounded-xl hover:rounded-3xl duration-300 bg-gradient-to-b from-teal-500 to-teal-800">
                <img
                  src={src}
                  alt="Portfolio"
                  className=" rounded-xl w-3/4 m-4 duration-300 shadow-2xl shadow-black"
                />
